...
export const deleteClientModal = () => {
    ...
    deleteModal.classList.add('delete-modal', 'main-modal', 'modal-active');
    deleteModalContent.classList.add('delete-modal__content', 'main-modal__content', 'modal-active');
    ...
    deleteModalTitle.textContent = 'Уалить клиента';
